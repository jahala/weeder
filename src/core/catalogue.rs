...
const CATALOGUE: &[Rule] = &[
    ...
    Rule {
        ...
        full_description: "A manifest pin is further behind the latest release than `[thresholds] dependency_lag` allows, measured against the committed registry snapshot.",
    },
];
