...
|---|---:|---:|
| `src/mcp/mod.rs` | 8 | 183 |
| `src/mcp/tools/definitions.rs` | 1 | 1 |
| `src/mcp/tools/deps.rs` | 4 | 1 |
| `src/mcp/tools/diff.rs` | 1 | 1 |
| `src/mcp/tools/edit.rs` | 25 | 2 |
| `src/mcp/tools/files.rs` | 71 | 1 |
| `src/mcp/tools/mod.rs` | 92 | 11 |
| `src/mcp/tools/read.rs` | 1 | 1 |
| `src/mcp/tools/search.rs` | 1 | 1 |
| `src/mcp/tools/session.rs` | 1 | 1 |
