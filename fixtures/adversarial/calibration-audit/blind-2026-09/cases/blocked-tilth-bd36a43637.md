...
|---|---:|---:|
| `src/index/mod.rs` | 0 | 3 |
| `src/index/symbol.rs` | 0 | 515 |
| `src/lib.rs` | 1 | 6 |
| `src/mcp.rs` | 2 | 11 |
| `src/search/mod.rs` | 0 | 8 |

```diff
diff --git a/src/index/mod.rs b/src/index/mod.rs
index a75525a..35e543e 100644
--- a/src/index/mod.rs
+++ b/src/index/mod.rs
@@ -1,4 +1 @@
 pub mod bloom;
