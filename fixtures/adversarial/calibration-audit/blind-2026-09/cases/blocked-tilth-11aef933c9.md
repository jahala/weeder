...
|---|---:|---:|
| `AGENTS.md` | 3 | 3 |
| `prompts/mcp-base.md` | 3 | 3 |
| `src/map.rs` | 1 | 1 |
| `src/mcp/mod.rs` | 4 | 3 |
| `src/mcp/tools/definitions.rs` | 32 | 8 |
| `src/mcp/tools/files.rs` | 0 | 170 |
| `src/mcp/tools/list.rs` | 191 | 0 |
| `src/mcp/tools/mod.rs` | 2 | 2 |
| `src/mcp/tree.rs` | 119 | 0 |
