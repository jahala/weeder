...
xtask/         the bench, never the product: `cargo xtask mutate` is the recall campaign, which plants one anti-pattern per case in real commits of the calibration corpus and writes the recall section of docs/calibration-2026-09.md
