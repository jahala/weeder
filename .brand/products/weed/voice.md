...
| Use | Not | Why |
|---|---|---|
| finding | violation, error, issue | weed reports what it found; the severity says how much it matters. |
...
| judge | reviewer, linter, scanner | weed judges a diff; it does not review code or scan for style. |
...
| honest work | clean code, quality | What weed can decide: that the tests still mean what they meant. It says nothing about whether the code is good. |
...
Product name is lowercase always: `weed`. The metaphor stays in the mark and the tagline;
